...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (e.matches) {
        document.querySelector(`link[title="dark code"]`).removeAttribute("disabled");
        document.querySelector(`link[title="light code"]`).setAttribute("disabled", "disabled");
    } else {
        document.querySelector(`link[title="light code"]`).removeAttribute("disabled");
        document.querySelector(`link[title="dark code"]`).setAttribute("disabled", "disabled");
    }
});
